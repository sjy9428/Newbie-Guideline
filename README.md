...
* [모두의 파이썬 20일 만에 배우는 프로그래밍 기초](https://book.naver.com/bookdb/book_detail.nhn?bid=14126163) : 파이썬 분야 & 어린이 코딩 교육 분야 2년 연속 베스트셀러! 
...
### AI
```
인공지능, 데이터 분석, 딥러닝 하고 싶으면 확률과 통계부터 시작하세요, 그리고 선형대수도 - 익명
```
